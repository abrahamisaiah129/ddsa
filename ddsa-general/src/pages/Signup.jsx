...
import signupImg from "../assets/Sign up-pana.svg";

export default function Signup() {
  const [step, setStep] = useState(1);
  const [accountType, setAccountType] = useState("");
  const sampleImg = signupImg;
  ...
  <div className="side-panel fw-bolder text-center">
      {/* ✅ Reduced height illustration */}
    <img
    ...
    >
      <motion.h2
        className="display-6 fw-bold mb-3 text-dark"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.2, duration: 0.6 }}
      >
        Join the <span className="brand text-danger">DDSA Community</span>
      </motion.h2>

      <motion.p
        className="lead fw-semibold text-muted mb-0"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.35, duration: 0.6 }}
      >
        Create your account — choose{" "}
        <span className="fw-bold text-dark">Individual</span> or{" "}
        <span className="fw-bold text-dark">Organization</span> and start your journey today.
      </motion.p>
    </motion.div>
  </div>
</div>
...
// DDSA
// Create your account and join our platform — choose Individual or Organization.