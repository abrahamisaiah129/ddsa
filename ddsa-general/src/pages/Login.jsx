...
import loginImg from "../assets/Secure login-pana.svg";
    ...
    <section className="auth-wrap">
      ...
      <div className="container py-5">
        <div className="row g-4 align-items-center">
          ...
          >
            <div className="side-panel fw-bolder">
              {/* ✅ Reduced height for the image */}
              <img
                src={SIDE_PANEL_IMG_URL}
                alt="Login banner"
                className="img-fluid"
            ...
            {/* ✅ Clean text below without background box */}
            <motion.div
            ...
            >
              ...
              >
                ...
                <span className="brand text-danger">Sales Agents</span>, Everywhere!
              </motion.h2>
              <motion.p
